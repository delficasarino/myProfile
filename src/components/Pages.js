    ...
    <section className="df wp jcc aic t-wp pages">
      <article className="df wp jcb fx-auto tags">
        <Button
          ...
          active={tag === "profile" ? true : false}
        />
        <Button
          name="Active Projects"
          onClick={() => setTag("activeWebs")}
          active={tag === "activeWebs" ? true : false}
        />
        <Button
          name="Progress Projects"
          onClick={() => setTag("processWeb")}
          active={tag === "processWeb" ? true : false}
        />
      </article>
      <article className="df wp jcc aic fx-auto">
        {tag === "profile" ? (
          <Profile active={tag === "profile" ? true : false} />
        ) : null}
        {tag === "activeWebs" ? (
          <ActiveWebs active={tag === "activeWebs" ? true : false} />
        ) : null}
        {tag === "processWeb" ? (
          <ProgressWebs active={tag === "processWeb" ? true : false} />
        ) : null}
      </article>
    </section>
  );
